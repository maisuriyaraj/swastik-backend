...
export const sendUploadIndentityDocuments = (customerName,customer_id) => {
  return `
    ...
    <body>
        <div class="container">
            <h1>Welcome to Our Website! ${customerName}</h1>
            <p>Please,upload your Adhar card and Pan Card From Below Link to verify your bank account KYC </p>
            <p>If you have any questions or need assistance, feel free to contact us.</p>
            <p>Thank you!</p>
            <a href="http://localhost:3000/user/upload-docs/${customer_id}" target="_blank" class="button">Please Upload your Documents</a>
        </div>
    </body>
    </html>
